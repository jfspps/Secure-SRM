...
create table report (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, comments varchar(255), student_id bigint, subject_id bigint, teacher_id bigint, primary key (id)) engine=InnoDB;
...
create table student (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, first_name varchar(255), last_name varchar(255), contact_detail_id bigint, form_group_list_id bigint, teacher_id bigint, primary key (id)) engine=InnoDB;
...
create table student_result (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, comments varchar(255), score varchar(255), student_id bigint, student_work_id bigint, teacher_id bigint, primary key (id)) engine=InnoDB;
create table student_work (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, contributor bit not null, max_score integer, title varchar(255), assignment_type_id bigint, subject_id bigint, teacher_uploader_id bigint, primary key (id)) engine=InnoDB;
...
create table test_record (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, record_name varchar(255), user_id bigint, primary key (id)) engine=InnoDB;
create table threshold (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, alphabetical varchar(255), numerical integer not null, primary key (id)) engine=InnoDB;
create table threshold_list (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, primary key (id)) engine=InnoDB;
...
create table user (id bigint not null auto_increment, created_date datetime, last_modified_date datetime, account_non_expired bit, account_non_locked bit, credentials_non_expired bit, enabled bit, password varchar(255), username varchar(255), admin_user_id bigint, contact_detail_id bigint, guardian_user_id bigint, root_user_id bigint, teacher_user_id bigint, primary key (id)) engine=InnoDB;
...
alter table user add constraint FK4xutfs6n3br4yilp66inl3pf foreign key (contact_detail_id) references contact_detail (id);
